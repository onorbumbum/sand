...
| `Sources/SandCore/Ephemeral/` | Ephemeral Sandbox Run planning, Host Mac lifecycle hooks, run records, failure result precedence, and create-run-stop-delete coordination. |
